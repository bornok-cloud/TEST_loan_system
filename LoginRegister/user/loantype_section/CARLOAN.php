...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($email !== $user_email) {
        ...
        echo "<div class='alert alert-danger'>Error: Loan amount must be between $5,000 and $100,000.</div>";
    } else {
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="form-container">
        <h2 class="text-center mb-4">Car Loan Application Form</h2>
        <form method="POST" action="CARLOAN.php">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="loan_amount" id="loan_amount" min="5000" max="100000" required>
            </div>
